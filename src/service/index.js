 ...
 */
export const sendRegSMS = cellPhone =>
  axios({
 ...
 */
export const phoneCodeCheck = (cellPhone, code) =>
  axios({
 ...
 */
export const sendSMS = (cellPhone, key) =>
  axios({
 ...
 */
export const codeCheck = (cellPhone, key) =>
  axios({
 ...
 */
export const userSignInfo = (uid, token) =>
  axios({
 ...
 */
export const shareList = (uid, token, curPage) =>
  axios({
 ...
 */
export const machineYear = (uid, token, type) =>
  axios({
 ...
 */
export const loansDital = (uid, token, id) =>
  axios({
 ...
 */
export const loansInvestList = (id, curPage) =>
  axios({
 ...
 * @param {String} curPage page number
 */
export const loansRepaymentList = (id, curPage) =>
  axios({
 ...
 */
export const loansOverList = (curPage, numDays) =>
  axios({
 ...
 * @param {String} token token
 */
export const autoInvest = (uid, token) =>
  axios({
 ...
 * @param {String} token token
 */
export const closeAutoBid = (uid, token) =>
  axios({
 ...
 */
export const noticeList = (uid, token, curPage) =>
  axios({
 ...
 * @param {String} token token
 */
export const personInfo = (uid, token) =>
  axios({
 ...
 * @param {String} token token
 */
export const current = (uid, token) =>
  axios({
 ...
 * @param {String} token token
 */
export const balance = (uid, token) =>
  axios({
 ...
 * @param {String} token token
 */
export const balanceRechargeInit = (uid, token) =>
  axios({
 ...
 */
export const accountInfo = (uid, token, type) =>
  axios({
 ...
 * @param {String} token token
 */
export const myInvitation = (uid, token) =>
  axios({
 ...
 * @param {String} drawId luckdraw id
 */
export const luckyDrawRule = drawId =>
  axios({
 ...
 * @param {String} token token
 */
export const userTask = (uid, token) =>
  axios({
 ...
 * @param {String} token token
 */
export const catTicket = (uid, token) =>
  axios({
 ...
 * @param {String} token token
 */
export const myCatFood = (uid, token) =>
  axios({
